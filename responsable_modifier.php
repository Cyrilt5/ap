                ...
                <div class="container">
                    <div class="row">
                        <article class="col-md-5">
                            ...
                            <tbody>
                                <form action= "page_responsable_modifier.php" method="post">
                                    <?php 
                                        for($i=1;$i<=$_SESSION['iddemande'];$i++){
                                            echo"
                                                <tr>
                                                    <th scope=\"row\">". $numdemande[$i]."</th>
                                                    <td>".$objectdemande[$i]."</td>
                                                    <td><textarea id=\"priori\" name=\"priori\"
                                                    rows=\"5\" cols=\"33\" required>".$idpriorite[$i]."</textarea></td>
